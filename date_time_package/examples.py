...
def run():
    ...
    example1_dict = {'_day': 21,
                     '_month': 7,
                     '_year': 1998,
                     '_hour': 21,
                     '_minute': 48}
    print("Данные словаря:\n"
          f"{example1_dict}")
    ...
    print("Пример 3 - Попытка создания объекта Дата/Время на основе словаря с некорректными данными")
    wrong_example_dict = {'_day': 32,
                          '_month': -17,
                          '_year': '1998',
                          '_hour': None,
                          '_minute': 6000}
    print("Данные словаря:\n"
          f"{wrong_example_dict}")
    ...
    print("\nПример 4 - Создание контейнера для созданных раннее объектов Дата/Время")
    ...
    print("\nПример 5 - Сохранение первого созданного объекта Дата/Время в JSON и загрузка данных во второй")
